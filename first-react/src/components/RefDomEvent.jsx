    ...
    render() {
        return (
            <div>
                ...
                <hr />
                <h3>
                    컴포넌트를 불러와서 ref를 통해 가져올수 있다</h3>
                    <EventComp ref={this.myComp}/>
                <button
                // 컴포넌트를 ref로 들고오게 되면 그 컴포넌트에 있는
                // 메소드, state, props에 다 접근할수 있다.
                // state와 props의 경우 값을 가져올수 있고
                // 메소드의 경우 메소드를 실행할수 있다
                ...
                <h3>
                    ...
                    <p>
                        자바스크립트에서 addEventListsener를 사용할때와 동일한 이유</p>
                        <p>addEventListsener를 사용하여 함수를 넣을때
                            함수 이름을 넣어서 실행
