...
export default function EffectHook2() {
  ...
  const getMenu = async ()=>{
    const promise = await fetch("https://busan-food.openapi.redtable.global/api/menu-dscrn/korean?serviceKey=rR4qxtvAibNCiGQsCpXc7WBPH15kkLWdhLH13MhBCHA6eKQFJa40DorbfioAvVYA&pageNo=2");
